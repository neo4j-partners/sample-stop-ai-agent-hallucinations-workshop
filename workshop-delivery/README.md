...
For the deployable service boundary and the frozen retrieval and command contracts, see `06-agentcore-boto3-demo/CONTRACTS.md` and `06-agentcore-boto3-demo/DEPLOYMENT.md`. For the architecture visual, see `workshop-delivery/architecture.md`.
